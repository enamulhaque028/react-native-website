...
## v1.8.0: Real data added for east stations

git commit -m "Cloned facebook"
...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/react-native-website
...
git push --all -f https://github.com/sakib-rahman-bangladesh/react-native-website
